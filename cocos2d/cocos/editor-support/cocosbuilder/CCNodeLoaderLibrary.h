...
namespace cocosbuilder {
    ...
    public:
        ...
        CC_DEPRECATED_ATTRIBUTE void registerCCNodeLoader( const char *pClassName, NodeLoader *pNodeLoader ) {
            registerNodeLoader( pClassName, pNodeLoader );
        };
        /**
         * @js NA
         * @lua NA
        ...
        CC_DEPRECATED_ATTRIBUTE void unregisterCCNodeLoader( const char *pClassName ) {
            unregisterNodeLoader( pClassName );
        };
        /**
         * @js NA
         * @lua NA
        ...
        CC_DEPRECATED_ATTRIBUTE NodeLoader *getCCNodeLoader( const char *pClassName ) {
            return getNodeLoader( pClassName );
        };
    ...
    public:
         ...
         * @lua NA
         */
        CC_DEPRECATED_ATTRIBUTE static NodeLoaderLibrary *
        sharedNodeLoaderLibrary() { return NodeLoaderLibrary::getInstance(); };
        /**
         * @js NA
         * @lua NA
         */
         ...
         */
        CC_DEPRECATED_ATTRIBUTE static NodeLoaderLibrary *
        newDefaultCCNodeLoaderLibrary() { return NodeLoaderLibrary::newDefaultNodeLoaderLibrary(); };
