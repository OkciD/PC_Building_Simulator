...
#define PROPERTY_STRING "string"
    ...
    void
    LabelBMFontLoader::onHandlePropTypeColor3( Node *pNode, Node *pParent, const char *pPropertyName, Color3B pColor3B,
                                               CCBReader *ccbReader ) {
    ...
    void
    LabelBMFontLoader::onHandlePropTypeByte( Node *pNode, Node *pParent, const char *pPropertyName, unsigned char pByte,
                                             CCBReader *ccbReader ) {
    ...
    void LabelBMFontLoader::onHandlePropTypeBlendFunc( Node *pNode, Node *pParent, const char *pPropertyName,
    ...
    void LabelBMFontLoader::onHandlePropTypeFntFile( Node *pNode, Node *pParent, const char *pPropertyName,
    ...
    void
    LabelBMFontLoader::onHandlePropTypeText( Node *pNode, Node *pParent, const char *pPropertyName, const char *pText,
                                             CCBReader *ccbReader ) {
