...
namespace cocosbuilder {
    ...
    void SpriteLoader::onHandlePropTypeSpriteFrame( Node *pNode, Node *pParent, const char *pPropertyName,
    ...
    void SpriteLoader::onHandlePropTypeFlip( Node *pNode, Node *pParent, const char *pPropertyName, bool *pFlip,
                                             CCBReader *ccbReader ) {
    ...
    void SpriteLoader::onHandlePropTypeColor3( Node *pNode, Node *pParent, const char *pPropertyName, Color3B pColor3B,
                                               CCBReader *ccbReader ) {
    ...
    void SpriteLoader::onHandlePropTypeByte( Node *pNode, Node *pParent, const char *pPropertyName, unsigned char pByte,
                                             CCBReader *ccbReader ) {
    ...
    void SpriteLoader::onHandlePropTypeBlendFunc( Node *pNode, Node *pParent, const char *pPropertyName,
