...
namespace cocostudio {
    ...
    Type stExpCocoNode::GetType( CocoLoader *pCoco ) {
        ...
        if ( m_ObjIndex >= 0 ) {
            ...
            if ( m_AttribIndex >= 0 ) {
                stExpCocoAttribDesc *tpAttribDescArray = ( stExpCocoAttribDesc * ) tpCocoObjectDesc[m_ObjIndex].GetAttribDescArray(
                        pCoco );
    ...
    char *stExpCocoNode::GetName( CocoLoader *pCoco ) {
        ...
        if ( m_ObjIndex >= 0 ) {
            ...
            if ( m_AttribIndex >= 0 ) {
                char *pStringAddr =
                        ( char * ) pCoco->GetCocoObjectDescArray() + pCoco->GetFileHeader()->m_lStringMemAddr;
