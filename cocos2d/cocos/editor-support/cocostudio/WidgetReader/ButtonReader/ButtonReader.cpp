...
namespace cocostudio {
    ...
    void
    ButtonReader::setPropsFromBinary( cocos2d::ui::Widget *widget, CocoLoader *cocoLoader, stExpCocoNode *cocoNode ) {
    ...
    void ButtonReader::setPropsFromJsonDictionary( Widget *widget, const rapidjson::Value &options ) {
        ...
        std::string normalTexturePath = this->getResourcePath( normalDic, P_Path,
                                                               ( Widget::TextureResType ) normalType );
        ...
        std::string pressedTexturePath = this->getResourcePath( pressedDic, P_Path,
                                                                ( Widget::TextureResType ) pressedType );
        ...
        std::string disabledTexturePath = this->getResourcePath( disabledDic, P_Path,
                                                                 ( Widget::TextureResType ) disabledType );
    ...
    Offset<Table> ButtonReader::createOptionsWithFlatBuffers( const tinyxml2::XMLElement *objectData,
    ...
    void ButtonReader::setPropsWithFlatBuffers( cocos2d::Node *node, const flatbuffers::Table *buttonOptions ) {
        ...
        if ( outlineEnabled ) {
            ...
            if ( f_outlineColor ) {
                Color4B outlineColor( f_outlineColor->r(), f_outlineColor->g(), f_outlineColor->b(),
                                      f_outlineColor->a() );
