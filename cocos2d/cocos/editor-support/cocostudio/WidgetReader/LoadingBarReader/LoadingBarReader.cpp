...
namespace cocostudio {
    ...
    void LoadingBarReader::setPropsFromBinary( cocos2d::ui::Widget *widget, CocoLoader *cocoLoader,
    ...
    void LoadingBarReader::setPropsFromJsonDictionary( Widget *widget, const rapidjson::Value &options ) {
        ...
        std::string imageFileName = this->getResourcePath( imageFileNameDic, P_Path,
                                                           ( Widget::TextureResType ) imageFileNameType );
