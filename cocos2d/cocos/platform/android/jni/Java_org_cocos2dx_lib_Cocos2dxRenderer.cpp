...
JNIEXPORT void JNICALL
Java_org_cocos2dx_lib_Cocos2dxRenderer_nativeInsertText(JNIEnv
* env,
...
dispatchInsertText(pszText, strlen( pszText )
);
}

JNIEXPORT void JNICALL
Java_org_cocos2dx_lib_Cocos2dxRenderer_nativeDeleteBackward(JNIEnv
* env,
jobject thiz
) {
...
JNICALL Java_org_cocos2dx_lib_Cocos2dxRenderer_nativeGetContentText() {
    JNIEnv * env = 0;
