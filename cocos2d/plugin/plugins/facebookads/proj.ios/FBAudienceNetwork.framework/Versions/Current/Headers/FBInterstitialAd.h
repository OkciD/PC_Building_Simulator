 ...
 */
@
interface FBInterstitialAd :
UIViewController <FBAdViewDelegate>
 ...
 */
- (BOOL)
showAdFromRootViewController: ( UIViewController * )
rootViewController;
 ...
 */
- (void)
interstitialAdDidClick: ( FBInterstitialAd * )
interstitialAd;
/*!
 @method
 ...
 */
- (void)
interstitialAdDidClose: ( FBInterstitialAd * )
interstitialAd;
/*!
 @method
 ...
 */
- (void)
interstitialAdWillClose: ( FBInterstitialAd * )
interstitialAd;
/*!
 @method
 ...
 */
- (void)
interstitialAdDidLoad: ( FBInterstitialAd * )
interstitialAd;
/*!
 @method
