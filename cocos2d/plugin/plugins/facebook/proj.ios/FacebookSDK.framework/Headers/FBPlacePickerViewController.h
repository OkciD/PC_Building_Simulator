 ...
 */
+ (FBCacheDescriptor *)
cacheDescriptorWithLocationCoordinate: ( CLLocationCoordinate2D )
locationCoordinate
        radiusInMeters:
(NSInteger)
radiusInMeters
 ...
 */
- (void)
placePickerViewControllerDataDidChange: ( FBPlacePickerViewController * )
placePicker;
 ...
 */
- (void)
placePickerViewControllerSelectionDidChange: ( FBPlacePickerViewController * )
placePicker;
 ...
 */
- (BOOL)
placePickerViewController: ( FBPlacePickerViewController * )
placePicker
        shouldIncludePlace:
(id <FBGraphPlace>)
place;
