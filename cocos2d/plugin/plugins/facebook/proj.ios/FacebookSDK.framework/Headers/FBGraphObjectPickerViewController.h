...
IBOutlet UIActivityIndicatorView
*
spinner;
 ...
 */
- (void)
graphObjectPickerViewControllerDataDidChange: ( FBGraphObjectPickerViewController * )
graphObjectPicker;
 ...
 */
- (void)
graphObjectPickerViewControllerSelectionDidChange: ( FBGraphObjectPickerViewController * )
graphObjectPicker;
 ...
 */
- (BOOL)
graphObjectPickerViewController: ( FBGraphObjectPickerViewController * )
graphObjectPicker
        shouldIncludeGraphObject:
(id <FBGraphObject>)
object;
