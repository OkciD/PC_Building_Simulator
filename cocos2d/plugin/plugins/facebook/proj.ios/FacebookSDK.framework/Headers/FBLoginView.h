...
NSArray *permissions __attribute__((deprecated));
...
FBLoginViewTooltipBehavior tooltipBehavior;
...
FBTooltipColorStyle tooltipColorStyle;
...
permissions __attribute__((deprecated));
 ...
 */
- (instancetype)
initWithReadPermissions: ( NSArray * )
readPermissions;
 ...
 */
- (instancetype)
initWithPublishPermissions: ( NSArray * )
publishPermissions
        defaultAudience:
...
IBOutlet id<FBLoginViewDelegate>
delegate;
 ...
 */
- (void)
loginViewShowingLoggedInUser: ( FBLoginView * )
loginView;
 ...
 */
- (void)
loginViewFetchedUserInfo: ( FBLoginView * )
loginView
        user:
(id <FBGraphUser>)
user;
