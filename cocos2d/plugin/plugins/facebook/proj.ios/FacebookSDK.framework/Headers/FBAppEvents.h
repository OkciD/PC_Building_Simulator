...
+ (void)
setLimitEventUsage: ( BOOL )
limitEventUsage __attribute__ ((deprecated("use [FBSettings setLimitEventAndDataUsage] instead")));
 ...
 */
+ (void)
setFlushBehavior: ( FBAppEventsFlushBehavior )
flushBehavior;
 ...
 */
+ (void)
setLoggingOverrideAppID: ( NSString * )
appID;
