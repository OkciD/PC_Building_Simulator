 ...
 */
+ (NSMutableDictionary <FBGraphObject> *)
graphObjectWrappingDictionary: ( NSDictionary * )
jsonDictionary;
 ...
 */
+ (NSMutableDictionary <FBOpenGraphAction> *)
 ...
 */
+ (NSMutableDictionary <FBOpenGraphObject> *)
openGraphObjectForPostWithType: ( NSString * )
type
        title:
(NSString *)
title
 ...
 */
+ (BOOL)
isGraphObjectID: ( id < FBGraphObject > )
anObject sameAs:
(id <FBGraphObject>)
anotherObject;
