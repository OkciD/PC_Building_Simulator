 ...
 */
- (void)
requestConnectionWillBeginLoading: ( FBRequestConnection * )
connection
        fromCache:
(BOOL)
isCached;
 ...
 */
- (void)
requestConnectionDidFinishLoading: ( FBRequestConnection * )
connection
        fromCache:
(BOOL)
isCached;
 ...
 */
- (void)
requestConnection: ( FBRequestConnection * )
connection
        didFailWithError:
(NSError *)
error;
...
requestConnection: ( FBRequestConnection * )
connection
        willRetryWithRequestConnection:
(FBRequestConnection *)
retryConnection;
...
- (instancetype)
initWithTimeout: ( NSTimeInterval )
timeout;
 ...
 */
- (void)
overrideVersionPartWith: ( NSString * )
version;
 ...
 */
+ (FBRequestConnection *)
startForMeWithCompletionHandler: ( FBRequestHandler )
handler;
 ...
 */
+ (FBRequestConnection *)
startForMyFriendsWithCompletionHandler: ( FBRequestHandler )
handler;
 ...
 */
+ (FBRequestConnection *)
startForPostStatusUpdate: ( NSString * )
message
        completionHandler:
(FBRequestHandler)
handler;
 ...
 */
+ (FBRequestConnection *)
startForCustomAudienceThirdPartyID: ( FBSession * )
session
        completionHandler:
(FBRequestHandler)
handler;
 ...
 */
+ (FBRequestConnection *)
startForPostWithGraphPath: ( NSString * )
graphPath
        graphObject:
(id <FBGraphObject>)
graphObject
 ...
 */
+ (FBRequestConnection *)
startForPostOpenGraphObject: ( id < FBOpenGraphObject > )
object
        completionHandler:
(FBRequestHandler)
handler;
 ...
 */
+ (FBRequestConnection *)
startForPostOpenGraphObjectWithType: ( NSString * )
type
        title:
(NSString *)
title
 ...
 */
+ (FBRequestConnection *)
startForUpdateOpenGraphObject: ( id < FBOpenGraphObject > )
object
        completionHandler:
(FBRequestHandler)
handler;
 ...
 */
+ (FBRequestConnection *)
startForUpdateOpenGraphObjectWithId: ( id )
objectId
        title:
(NSString *)
title
 ...
 */
+ (FBRequestConnection *)
startForUploadStagingResourceWithImage: ( UIImage * )
image
        completionHandler:
(FBRequestHandler)
handler;
