 ...
 */
+ (BOOL)
presentOSIntegratedShareDialogModallyFrom: ( UIViewController * )
viewController
        initialText:
(NSString *)
initialText
 ...
 */
+ (BOOL)
canPresentOSIntegratedShareDialogWithSession: ( FBSession * )
session;
...
*/
+ (BOOL)
canPresentShareDialogWithOpenGraphActionParams: ( FBOpenGraphActionParams * )
params;
...
*/
+ (BOOL)
canPresentShareDialogWithParams: ( FBLinkShareParams * )
params;
 ...
 */
+ (FBAppCall *)
presentShareDialogWithParams: ( FBLinkShareParams * )
params
        clientState:
(NSDictionary *)
clientState
 ...
 */
+ (FBAppCall *)
presentShareDialogWithLink: ( NSURL * )
link
        handler:
(FBDialogAppCallCompletionHandler)
handler;
 ...
 */
+ (FBAppCall *)
presentShareDialogWithPhotoParams: ( FBPhotoParams * )
params
        clientState:
(NSDictionary *)
clientState
 ...
 */
+ (FBAppCall *)
presentShareDialogWithPhotos: ( NSArray * )
photos
        handler:
(FBDialogAppCallCompletionHandler)
handler;
 ...
 */
+ (FBAppCall *)
presentShareDialogWithOpenGraphActionParams: ( FBOpenGraphActionParams * )
params
        clientState:
(NSDictionary *)
clientState
...
/*!
 ...
 canPresentShareDialogWithOpenGraphActionParams method is also returning YES for the same params.
 */+ (FBAppCall *)
presentShareDialogWithOpenGraphAction: ( id < FBOpenGraphAction > )
action
        actionType:
(NSString *)
actionType
...
*/
+ (BOOL)
canPresentMessageDialogWithOpenGraphActionParams: ( FBOpenGraphActionParams * )
params;
...
*/
+ (BOOL)
canPresentMessageDialogWithParams: ( FBLinkShareParams * )
params;
 ...
 */
+ (FBAppCall *)
presentMessageDialogWithOpenGraphActionParams: ( FBOpenGraphActionParams * )
params
        clientState:
(NSDictionary *)
clientState
...
/*!
 ...
 canPresentMessageDialogWithOpenGraphActionParams method is also returning YES for the same params.
 */+ (FBAppCall *)
presentMessageDialogWithOpenGraphAction: ( id < FBOpenGraphAction > )
action
        actionType:
(NSString *)
actionType
 ...
 */
+ (FBAppCall *)
presentMessageDialogWithPhotoParams: ( FBPhotoParams * )
params
        clientState:
(NSDictionary *)
clientState
 ...
 */
+ (FBAppCall *)
presentMessageDialogWithPhotos: ( NSArray * )
photos
        handler:
(FBDialogAppCallCompletionHandler)
handler;
 ...
 */
+ (FBAppCall *)
presentMessageDialogWithParams: ( FBLinkShareParams * )
params
        clientState:
(NSDictionary *)
clientState
 ...
 */
+ (FBAppCall *)
presentMessageDialogWithLink: ( NSURL * )
link
        handler:
(FBDialogAppCallCompletionHandler)
handler;
