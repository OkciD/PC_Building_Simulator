...
appVersion __attribute__ ((deprecated("App Events favors use of bundle identifiers for version identification.")));
 ...
 */
+ (void)
setDefaultDisplayName: ( NSString * )
displayName;
 ...
 */
+ (void)
setResourceBundleName: ( NSString * )
bundleName;
 ...
 */
+ (void)
setFacebookDomainPart: ( NSString * )
facebookDomainPart;
 ...
 */
+ (void)
enableBetaFeature: ( FBBetaFeatures )
betaFeature;
 ...
 */
+ (void)
disableBetaFeature: ( FBBetaFeatures )
betaFeature;
 ...
 */
+ (BOOL)
isBetaFeatureEnabled: ( FBBetaFeatures )
betaFeature;
 ...
 */
+ (void)
setLimitEventAndDataUsage: ( BOOL )
limitEventAndDataUsage;
...
*/
+ (void)
enablePlatformCompatibility: ( BOOL )
enable;
