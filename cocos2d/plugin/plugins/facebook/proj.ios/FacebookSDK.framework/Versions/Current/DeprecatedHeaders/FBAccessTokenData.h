 ...
 */
+ (FBAccessTokenData *)
createTokenFromFacebookURL: ( NSURL * )
url appID:
(NSString *)
appID urlSchemeSuffix:
(NSString *)
urlSchemeSuffix;
 ...
 */
+ (FBAccessTokenData *)
createTokenFromDictionary: ( NSDictionary * )
dictionary;
 ...
 */
+ (FBAccessTokenData *)
createTokenFromString: ( NSString * )
accessToken
        permissions:
(NSArray *)
permissions
 ...
 */
- (BOOL)
isEqualToAccessTokenData: ( FBAccessTokenData * )
accessTokenData;
