...
+ (void)
setAppVersion: ( NSString * )
appVersion __attribute__((deprecated("use [FBSettings setAppVersion] instead")));

+ (void)
logPurchase: ( double )
purchaseAmount currency:
(NSString *)currency __attribute__((deprecated("use [FBAppEvents logPurchase] instead")));
+ (void)
logPurchase: ( double )
purchaseAmount currency:
(NSString *)
currency parameters:
(NSDictionary *)parameters __attribute__((deprecated("use [FBAppEvents logPurchase] instead")));
+ (void)
logPurchase: ( double )
purchaseAmount currency:
(NSString *)
...
(NSDictionary *)
parameters session:
(FBSession *)session __attribute__((deprecated("use [FBAppEvents logPurchase] instead")));

+ (void)
logConversionPixel: ( NSString * )
pixelID valueOfPixel:
(double)value __attribute__((deprecated));
+ (void)
logConversionPixel: ( NSString * )
pixelID valueOfPixel:
(double)
value session:
(FBSession *)session __attribute__((deprecated));

+ (FBInsightsFlushBehavior)flushBehavior __attribute__((deprecated("use [FBAppEvents flushBehavior] instead")));
+ (void)
setFlushBehavior: ( FBInsightsFlushBehavior )
flushBehavior __attribute__((deprecated("use [FBAppEvents setFlushBehavior] instead")));
