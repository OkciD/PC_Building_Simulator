 ...
 */
- (void)
openWithCompletionHandler: ( FBSessionStateHandler )
handler;
 ...
 */
- (void)
openWithBehavior: ( FBSessionLoginBehavior )
behavior
        completionHandler:
 ...
 */
- (BOOL)
openFromAccessTokenData: ( FBAccessTokenData * )
accessTokenData completionHandler:
(FBSessionStateHandler)
handler;
 ...
 */
- (void)
reauthorizeWithPermissions: ( NSArray * )
permissions
        behavior:
(FBSessionLoginBehavior)
behavior
        completionHandler:
(FBSessionReauthorizeResultHandler)handler
__attribute__((deprecated));
 ...
 */
- (void)
reauthorizeWithReadPermissions: ( NSArray * )
readPermissions
        completionHandler:
(FBSessionReauthorizeResultHandler)handler
__attribute__((deprecated));
 ...
 */
- (void)
reauthorizeWithPublishPermissions: ( NSArray * )
writePermissions
        defaultAudience:
(FBSessionDefaultAudience)
defaultAudience
 ...
 */
- (void)
requestNewReadPermissions: ( NSArray * )
readPermissions
        completionHandler:
 ...
 */
- (void)
refreshPermissionsWithCompletionHandler: ( FBSessionRequestPermissionResultHandler )
handler;
 ...
 */
- (void)
setStateChangeHandler: ( FBSessionStateHandler )
stateChangeHandler;
 ...
 */
+ (BOOL)
openActiveSessionWithAllowLoginUI: ( BOOL )
allowLoginUI;
 ...
 */
+ (BOOL)
openActiveSessionWithPermissions: ( NSArray * )
permissions
        allowLoginUI:
(BOOL)
allowLoginUI
 ...
 */
+ (BOOL)
openActiveSessionWithReadPermissions: ( NSArray * )
readPermissions
        allowLoginUI:
(BOOL)
allowLoginUI
 ...
 */
+ (BOOL)
openActiveSessionWithPublishPermissions: ( NSArray * )
publishPermissions
        defaultAudience:
(FBSessionDefaultAudience)
defaultAudience
 ...
 */
+ (void)
setDefaultAppID: ( NSString * )
appID __attribute__((deprecated));
 ...
 */
+ (void)
setDefaultUrlSchemeSuffix: ( NSString * )
urlSchemeSuffix __attribute__((deprecated));
 ...
 */
+ (void)
renewSystemCredentials: ( FBSessionRenewSystemCredentialsHandler )
handler;
@end
