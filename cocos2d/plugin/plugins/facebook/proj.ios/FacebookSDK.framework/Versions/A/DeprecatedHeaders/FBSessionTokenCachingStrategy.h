 ...
 */
- (instancetype)
initWithUserDefaultTokenInformationKeyName: ( NSString * )
 ...
 */
- (void)
cacheTokenInformation: ( NSDictionary * )
tokenInformation;
 ...
 */
- (void)
cacheFBAccessTokenData: ( FBAccessTokenData * )
accessToken;
 ...
 */
+ (BOOL)
isValidTokenInformation: ( NSDictionary * )
tokenInformation;
