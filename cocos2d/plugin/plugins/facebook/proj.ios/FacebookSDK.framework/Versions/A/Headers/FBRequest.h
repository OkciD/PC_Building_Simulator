 ...
 */
- (instancetype)
initForPostWithSession: ( FBSession * )
session
        graphPath:
(NSString *)
graphPath
 ...
 */
- (FBRequestConnection *)
startWithCompletionHandler: ( FBRequestHandler )
handler;
 ...
 */
+ (FBRequest *)
requestForPostStatusUpdate: ( NSString * )
message;
 ...
 */
+ (FBRequest *)
requestForPlacesSearchAtCoordinate: ( CLLocationCoordinate2D )
coordinate
        radiusInMeters:
(NSInteger)
radius
 ...
 */
+ (FBRequest *)
requestForCustomAudienceThirdPartyID: ( FBSession * )
session;
 ...
 */
+ (FBRequest *)
requestForPostWithGraphPath: ( NSString * )
graphPath
        graphObject:
(id <FBGraphObject>)
graphObject;
 ...
 */
+ (FBRequest *)
requestForPostOpenGraphObject: ( id < FBOpenGraphObject > )
object;
 ...
 */
+ (FBRequest *)
requestForPostOpenGraphObjectWithType: ( NSString * )
type
        title:
(NSString *)
title
 ...
 */
+ (FBRequest *)
requestForUpdateOpenGraphObject: ( id < FBOpenGraphObject > )
object;
 ...
 */
+ (FBRequest *)
requestForUpdateOpenGraphObjectWithId: ( id )
objectId
        title:
(NSString *)
title
 ...
 */
+ (FBRequest *)
requestForUploadStagingResourceWithImage: ( UIImage * )
image;
