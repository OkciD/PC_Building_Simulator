...
- (void)
adViewDidReceiveAd: ( GADBannerView * )
view;
...
/// is called.
- (void)
adViewWillPresentScreen: ( GADBannerView * )
adView;

/// Called just before dismissing a full screen view.
- (void)
adViewWillDismissScreen: ( GADBannerView * )
adView;
...
- (void)
adViewDidDismissScreen: ( GADBannerView * )
adView;
...
/// before this.
- (void)
adViewWillLeaveApplication: ( GADBannerView * )
adView;
