...
+ (void)
displayAdForSpace: ( NSString * )
space modallyForViewController:
(UIViewController *)
viewController;
 ...
 */
+(BOOL)
isAdAvailableForSpace: ( NSString * )
space view:
(UIView *)
view size:
(FlurryAdSize)
size timeout:
(int64_t)timeout __attribute__ ((deprecated));
 ...
 */
+ (void)
fetchAndDisplayAdForSpace: ( NSString * )
space view:
(UIView *)
viewContainer size:
(FlurryAdSize)
 ...
 */
+ (void)
setKeywordsForTargeting: ( NSDictionary * )
keywords;
 ...
 */
+ (void)
addCustomAdNetwork: ( Class < FlurryCustomAdNetwork > )
adNetworkClass withProperties:
(id <FlurryCustomAdNetworkProperties>)
adNetworkProperties;
