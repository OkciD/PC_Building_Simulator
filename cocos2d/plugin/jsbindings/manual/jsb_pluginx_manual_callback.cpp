...
public:
    virtual void
    onPayResult( cocos2d::plugin::PayResultCode ret, const char *msg, cocos2d::plugin::TProductInfo info ) {
        ...
        if ( JS_HasProperty( cx, obj, "onPayResult", &hasAction ) && hasAction ) {
            ...
            JS_CallFunctionName( cx, obj, "onPayResult", JS::HandleValueArray::fromMarkedLocation( 3, dataVal ),
                                 &retval );
        }
    }
...
bool js_pluginx_ProtocolIAP_getResultListener( JSContext *cx, uint32_t argc, jsval *vp ) {
    ...
    JS_ReportError( cx, "js_pluginx_ProtocolIAP_getResultListener : wrong number of arguments: %d, was expecting %d",
                    argc, 0 );
    return false;
}
...
bool js_pluginx_ProtocolIAP_payForProduct( JSContext *cx, uint32_t argc, jsval *vp ) {
    ...
    if ( argc == 1 ) {
        ...
        JSB_PRECONDITION2( ok, cx, false,
                           "js_pluginx_protocols_ProtocolIAP_payForProduct : Error processing arguments" );
    ...
    if ( argc == 2 ) {
        ...
        do {
            std::shared_ptr<JSFunctionWrapper> func(
                    new JSFunctionWrapper( cx, JS_THIS_OBJECT( cx, vp ), args.get( 1 ) ) );
...
public:
    ...
    virtual void onAdsResult( AdsResultCode code, const char *msg ) {
        ...
        if ( bRet && hasAction ) {
            ...
            JS_CallFunctionName( cx, obj, "onAdsResult", JS::HandleValueArray::fromMarkedLocation( 2, dataVal ),
                                 &retval );
        }
    }
    ...
    virtual void onPlayerGetPoints( ProtocolAds *pAdsPlugin, int points ) {
        ...
        if ( bRet && hasAction ) {
            ...
            JS_CallFunctionName( cx, obj, "onPlayerGetPoints", JS::HandleValueArray::fromMarkedLocation( 2, dataVal ),
                                 &retval );
        }
    }
...
bool js_pluginx_ProtocolAds_getAdsListener( JSContext *cx, uint32_t argc, jsval *vp ) {
    ...
    JS_ReportError( cx, "js_pluginx_ProtocolAds_getAdsListener : wrong number of arguments: %d, was expecting %d", argc,
                    0 );
    return false;
}
...
public:
    virtual void onShareResult( cocos2d::plugin::ShareResultCode ret, const char *msg ) {
        ...
        if ( JS_HasProperty( cx, obj, "onShareResult", &hasAction ) && hasAction ) {
            ...
            JS_CallFunctionName( cx, obj, "onShareResult", JS::HandleValueArray::fromMarkedLocation( 2, dataVal ),
                                 &retval );
        }
    }
...
bool js_pluginx_ProtocolShare_getResultListener( JSContext *cx, uint32_t argc, jsval *vp ) {
    ...
    JS_ReportError( cx, "js_pluginx_ProtocolShare_getResultListener : wrong number of arguments: %d, was expecting %d",
                    argc, 0 );
    return false;
}
...
public:
    virtual void onSocialResult( cocos2d::plugin::SocialRetCode ret, const char *msg ) {
        ...
        if ( JS_HasProperty( cx, obj, "onSocialResult", &hasAction ) && hasAction ) {
            ...
            JS_CallFunctionName( cx, obj, "onSocialResult", JS::HandleValueArray::fromMarkedLocation( 2, dataVal ),
                                 &retval );
        }
    }
...
bool js_pluginx_ProtocolSocial_getListener( JSContext *cx, uint32_t argc, jsval *vp ) {
    ...
    JS_ReportError( cx, "js_pluginx_ProtocolSocial_getListener : wrong number of arguments: %d, was expecting %d", argc,
                    0 );
    return false;
}
...
bool js_pluginx_ProtocolSocial_submitScore( JSContext *cx, uint32_t argc, jsval *vp ) {
    ...
    if ( argc == 2 ) {
        ...
        JSB_PRECONDITION2( ok, cx, false,
                           "js_pluginx_protocols_ProtocolSocial_submitScore : Error processing arguments" );
    ...
    if ( argc == 3 ) {
        ...
        do {
            std::shared_ptr<JSFunctionWrapper> func(
                    new JSFunctionWrapper( cx, JS_THIS_OBJECT( cx, vp ), args.get( 2 ) ) );
            auto lambda = [=]( int larg0, std::string &larg1 ) -> void {
                JSAutoCompartment ac( cx, obj );
                jsval largv[2];
                largv[0] = int32_to_jsval( cx, larg0 );
...
bool js_pluginx_ProtocolSocial_unlockAchievement( JSContext *cx, uint32_t argc, jsval *vp ) {
    ...
    JSB_PRECONDITION2( cobj, cx, false,
                       "js_pluginx_protocols_ProtocolSocial_unlockAchievement : Invalid Native Object" );
    if ( argc == 1 ) {
        cocos2d::plugin::TAchievementInfo arg0;
        ok &= pluginx::jsval_to_TAchievementInfo( cx, args.get( 0 ), &arg0 );
        JSB_PRECONDITION2( ok, cx, false,
                           "js_pluginx_protocols_ProtocolSocial_unlockAchievement : Error processing arguments" );
...
public:
    virtual void
    onActionResult( ProtocolUser *userPlugin, cocos2d::plugin::UserActionResultCode ret, const char *msg ) {
        JSContext *cx = s_cx;
        JS::RootedObject obj( cx, _JSDelegate );
        JSAutoCompartment ac( cx, obj );
        ...
        if ( JS_HasProperty( cx, obj, "onActionResult", &hasAction ) && hasAction ) {
            ...
            JS_CallFunctionName( cx, obj, "onActionResult", JS::HandleValueArray::fromMarkedLocation( 3, dataVal ),
                                 &retval );
        }
    }
...
bool js_pluginx_ProtocolUser_getActionListener( JSContext *cx, uint32_t argc, jsval *vp ) {
    ...
    JS_ReportError( cx, "js_pluginx_ProtocolUser_getActionListener : wrong number of arguments: %d, was expecting %d",
                    argc, 0 );
    return false;
}
...
bool js_pluginx_ProtocolUser_login( JSContext *cx, uint32_t argc, jsval *vp ) {
    ...
    do {
        if ( argc == 1 ) {
            ...
            do {
                std::shared_ptr<JSFunctionWrapper> func(
                        new JSFunctionWrapper( cx, JS_THIS_OBJECT( cx, vp ), args.get( 0 ) ) );
                auto lambda = [=]( int larg0, std::string &larg1 ) -> void {
                    JSAutoCompartment ac( cx, obj );
                    jsval largv[2];
                    largv[0] = int32_to_jsval( cx, larg0 );
...
bool js_pluginx_FacebookAgent_api( JSContext *cx, uint32_t argc, jsval *vp ) {
    ...
    do {
        if ( argc == 4 ) {
            ...
            do {
                std::shared_ptr<JSFunctionWrapper> func(
                        new JSFunctionWrapper( cx, JS_THIS_OBJECT( cx, vp ), args.get( 3 ) ) );
                auto lambda = [=]( int larg0, std::string &larg1 ) -> void {
                    JSAutoCompartment ac( cx, obj );
                    jsval largv[2];
                    largv[0] = int32_to_jsval( cx, larg0 );
...
bool js_pluginx_FacebookAgent_appRequest( JSContext *cx, uint32_t argc, jsval *vp ) {
    ...
    do {
        if ( argc == 2 ) {
            ...
            ok &= pluginx::jsval_to_TShareInfo( cx, args.get( 0 ), &arg0 );
            JSB_PRECONDITION2( ok, cx, false,
                               "js_pluginx_protocols_FacebookAgent_appRequest : Error processing arguments" );
            if ( !ok ) {
                ok = true;
                break;
            }
...
bool js_pluginx_FacebookAgent_dialog( JSContext *cx, uint32_t argc, jsval *vp ) {
    ...
    do {
        if ( argc == 2 ) {
            ...
            ok &= pluginx::jsval_to_TShareInfo( cx, args.get( 0 ), &arg0 );
            JSB_PRECONDITION2( ok, cx, false,
                               "js_pluginx_protocols_FacebookAgent_dialog : Error processing arguments" );
            if ( !ok ) {
                ok = true;
                break;
            }
