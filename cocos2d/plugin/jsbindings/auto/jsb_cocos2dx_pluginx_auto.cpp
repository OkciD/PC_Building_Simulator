...
bool js_pluginx_protocols_PluginProtocol_getPluginName( JSContext *cx, uint32_t argc, jsval *vp ) {
    ...
    JS_ReportError( cx,
                    "js_pluginx_protocols_PluginProtocol_getPluginName : wrong number of arguments: %d, was expecting %d",
                    argc, 0 );
    return false;
}
...
bool js_pluginx_protocols_PluginProtocol_getPluginVersion( JSContext *cx, uint32_t argc, jsval *vp ) {
    ...
    JSB_PRECONDITION2( cobj, cx, false,
                       "js_pluginx_protocols_PluginProtocol_getPluginVersion : Invalid Native Object" );
    if ( argc == 0 ) {
    ...
    JS_ReportError( cx,
                    "js_pluginx_protocols_PluginProtocol_getPluginVersion : wrong number of arguments: %d, was expecting %d",
                    argc, 0 );
    return false;
}
...
bool js_pluginx_protocols_PluginProtocol_getSDKVersion( JSContext *cx, uint32_t argc, jsval *vp ) {
    ...
    JS_ReportError( cx,
                    "js_pluginx_protocols_PluginProtocol_getSDKVersion : wrong number of arguments: %d, was expecting %d",
                    argc, 0 );
    return false;
}
...
bool js_pluginx_protocols_PluginProtocol_setDebugMode( JSContext *cx, uint32_t argc, jsval *vp ) {
    ...
    if ( argc == 1 ) {
        ...
        JSB_PRECONDITION2( ok, cx, false,
                           "js_pluginx_protocols_PluginProtocol_setDebugMode : Error processing arguments" );
    ...
    JS_ReportError( cx,
                    "js_pluginx_protocols_PluginProtocol_setDebugMode : wrong number of arguments: %d, was expecting %d",
                    argc, 1 );
    return false;
}
...
void js_register_pluginx_protocols_PluginProtocol( JSContext *cx, JS::HandleObject global ) {
    ...
    static JSFunctionSpec funcs[] = {
            JS_FN( "getPluginName", js_pluginx_protocols_PluginProtocol_getPluginName, 0,
                   JSPROP_PERMANENT | JSPROP_ENUMERATE ),
            JS_FN( "getPluginVersion", js_pluginx_protocols_PluginProtocol_getPluginVersion, 0,
                   JSPROP_PERMANENT | JSPROP_ENUMERATE ),
            JS_FN( "getSDKVersion", js_pluginx_protocols_PluginProtocol_getSDKVersion, 0,
                   JSPROP_PERMANENT | JSPROP_ENUMERATE ),
            JS_FN( "setDebugMode", js_pluginx_protocols_PluginProtocol_setDebugMode, 1,
                   JSPROP_PERMANENT | JSPROP_ENUMERATE ),
            JS_FS_END
    };
...
bool js_pluginx_protocols_PluginManager_unloadPlugin( JSContext *cx, uint32_t argc, jsval *vp ) {
    ...
    if ( argc == 1 ) {
        ...
        arg0 = arg0_tmp.c_str();
        JSB_PRECONDITION2( ok, cx, false,
                           "js_pluginx_protocols_PluginManager_unloadPlugin : Error processing arguments" );
    ...
    JS_ReportError( cx,
                    "js_pluginx_protocols_PluginManager_unloadPlugin : wrong number of arguments: %d, was expecting %d",
                    argc, 1 );
    return false;
}
...
bool js_pluginx_protocols_PluginManager_loadPlugin( JSContext *cx, uint32_t argc, jsval *vp ) {
    ...
    if ( argc == 1 ) {
        ...
        arg0 = arg0_tmp.c_str();
        JSB_PRECONDITION2( ok, cx, false,
                           "js_pluginx_protocols_PluginManager_loadPlugin : Error processing arguments" );
        cocos2d::plugin::PluginProtocol *ret = cobj->loadPlugin( arg0 );
        jsval jsret = JSVAL_NULL;
        do {
            if ( ret ) {
                js_proxy_t *jsProxy = js_get_or_create_proxy<cocos2d::plugin::PluginProtocol>( cx,
    ...
    JS_ReportError( cx,
                    "js_pluginx_protocols_PluginManager_loadPlugin : wrong number of arguments: %d, was expecting %d",
                    argc, 1 );
    return false;
}
...
bool js_pluginx_protocols_PluginManager_getInstance( JSContext *cx, uint32_t argc, jsval *vp ) {
    ...
    if ( argc == 0 ) {
        ...
        do {
            if ( ret ) {
                js_proxy_t *jsProxy = js_get_or_create_proxy<cocos2d::plugin::PluginManager>( cx,
                                                                                              ( cocos2d::plugin::PluginManager * ) ret );
                jsret = OBJECT_TO_JSVAL( jsProxy->obj );
            } else {
                jsret = JSVAL_NULL;
            }
...
void js_register_pluginx_protocols_PluginManager( JSContext *cx, JS::HandleObject global ) {
    ...
    static JSFunctionSpec funcs[] = {
            JS_FN( "unloadPlugin", js_pluginx_protocols_PluginManager_unloadPlugin, 1,
                   JSPROP_PERMANENT | JSPROP_ENUMERATE ),
            JS_FN( "loadPlugin", js_pluginx_protocols_PluginManager_loadPlugin, 1,
                   JSPROP_PERMANENT | JSPROP_ENUMERATE ),
            JS_FS_END
    };
    ...
    static JSFunctionSpec st_funcs[] = {
            ...
            JS_FN( "getInstance", js_pluginx_protocols_PluginManager_getInstance, 0,
                   JSPROP_PERMANENT | JSPROP_ENUMERATE ),
            JS_FS_END
    };
...
bool js_pluginx_protocols_ProtocolAnalytics_logTimedEventBegin( JSContext *cx, uint32_t argc, jsval *vp ) {
    ...
    JSB_PRECONDITION2( cobj, cx, false,
                       "js_pluginx_protocols_ProtocolAnalytics_logTimedEventBegin : Invalid Native Object" );
    if ( argc == 1 ) {
        const char *arg0;
        std::string arg0_tmp;
        ok &= jsval_to_std_string( cx, args.get( 0 ), &arg0_tmp );
        arg0 = arg0_tmp.c_str();
        JSB_PRECONDITION2( ok, cx, false,
                           "js_pluginx_protocols_ProtocolAnalytics_logTimedEventBegin : Error processing arguments" );
    ...
    JS_ReportError( cx,
                    "js_pluginx_protocols_ProtocolAnalytics_logTimedEventBegin : wrong number of arguments: %d, was expecting %d",
                    argc, 1 );
    return false;
}
...
bool js_pluginx_protocols_ProtocolAnalytics_logError( JSContext *cx, uint32_t argc, jsval *vp ) {
    ...
    if ( argc == 2 ) {
        ...
        arg1 = arg1_tmp.c_str();
        JSB_PRECONDITION2( ok, cx, false,
                           "js_pluginx_protocols_ProtocolAnalytics_logError : Error processing arguments" );
    ...
    JS_ReportError( cx,
                    "js_pluginx_protocols_ProtocolAnalytics_logError : wrong number of arguments: %d, was expecting %d",
                    argc, 2 );
    return false;
}
...
bool js_pluginx_protocols_ProtocolAnalytics_setCaptureUncaughtException( JSContext *cx, uint32_t argc, jsval *vp ) {
    ...
    cocos2d::plugin::ProtocolAnalytics *cobj = ( cocos2d::plugin::ProtocolAnalytics * )( proxy ? proxy->ptr : NULL );
    JSB_PRECONDITION2( cobj, cx, false,
                       "js_pluginx_protocols_ProtocolAnalytics_setCaptureUncaughtException : Invalid Native Object" );
    if ( argc == 1 ) {
        bool arg0;
        arg0 = JS::ToBoolean( JS::RootedValue( cx, args.get( 0 ) ) );
        JSB_PRECONDITION2( ok, cx, false,
                           "js_pluginx_protocols_ProtocolAnalytics_setCaptureUncaughtException : Error processing arguments" );
    ...
    JS_ReportError( cx,
                    "js_pluginx_protocols_ProtocolAnalytics_setCaptureUncaughtException : wrong number of arguments: %d, was expecting %d",
                    argc, 1 );
    return false;
}
...
bool js_pluginx_protocols_ProtocolAnalytics_setSessionContinueMillis( JSContext *cx, uint32_t argc, jsval *vp ) {
    ...
    cocos2d::plugin::ProtocolAnalytics *cobj = ( cocos2d::plugin::ProtocolAnalytics * )( proxy ? proxy->ptr : NULL );
    JSB_PRECONDITION2( cobj, cx, false,
                       "js_pluginx_protocols_ProtocolAnalytics_setSessionContinueMillis : Invalid Native Object" );
    if ( argc == 1 ) {
        long arg0;
        ok &= pluginx::jsval_to_long( cx, args.get( 0 ), &arg0 );
        JSB_PRECONDITION2( ok, cx, false,
                           "js_pluginx_protocols_ProtocolAnalytics_setSessionContinueMillis : Error processing arguments" );
    ...
    JS_ReportError( cx,
                    "js_pluginx_protocols_ProtocolAnalytics_setSessionContinueMillis : wrong number of arguments: %d, was expecting %d",
                    argc, 1 );
    return false;
}
...
bool js_pluginx_protocols_ProtocolAnalytics_logEvent( JSContext *cx, uint32_t argc, jsval *vp ) {
    ...
    if ( argc == 1 ) {
        ...
        arg0 = arg0_tmp.c_str();
        JSB_PRECONDITION2( ok, cx, false,
                           "js_pluginx_protocols_ProtocolAnalytics_logEvent : Error processing arguments" );
        cobj->logEvent( arg0 );
        args.rval().setUndefined();
        return true;
    }
    if ( argc == 2 ) {
        ...
        ok &= jsval_to_std_string( cx, args.get( 0 ), &arg0_tmp );
        arg0 = arg0_tmp.c_str();
        std::map <std::string, std::string> arg1_tmp;
        ok &= jsval_to_std_map_string_string( cx, args.get( 1 ), &arg1_tmp );
        arg1 = &arg1_tmp;
        JSB_PRECONDITION2( ok, cx, false,
                           "js_pluginx_protocols_ProtocolAnalytics_logEvent : Error processing arguments" );
    ...
    JS_ReportError( cx,
                    "js_pluginx_protocols_ProtocolAnalytics_logEvent : wrong number of arguments: %d, was expecting %d",
                    argc, 1 );
    return false;
}
...
bool js_pluginx_protocols_ProtocolAnalytics_startSession( JSContext *cx, uint32_t argc, jsval *vp ) {
    ...
    if ( argc == 1 ) {
        ...
        arg0 = arg0_tmp.c_str();
        JSB_PRECONDITION2( ok, cx, false,
                           "js_pluginx_protocols_ProtocolAnalytics_startSession : Error processing arguments" );
    ...
    JS_ReportError( cx,
                    "js_pluginx_protocols_ProtocolAnalytics_startSession : wrong number of arguments: %d, was expecting %d",
                    argc, 1 );
    return false;
}
...
bool js_pluginx_protocols_ProtocolAnalytics_stopSession( JSContext *cx, uint32_t argc, jsval *vp ) {
    ...
    JS_ReportError( cx,
                    "js_pluginx_protocols_ProtocolAnalytics_stopSession : wrong number of arguments: %d, was expecting %d",
                    argc, 0 );
    return false;
}
...
bool js_pluginx_protocols_ProtocolAnalytics_logTimedEventEnd( JSContext *cx, uint32_t argc, jsval *vp ) {
    ...
    cocos2d::plugin::ProtocolAnalytics *cobj = ( cocos2d::plugin::ProtocolAnalytics * )( proxy ? proxy->ptr : NULL );
    JSB_PRECONDITION2( cobj, cx, false,
                       "js_pluginx_protocols_ProtocolAnalytics_logTimedEventEnd : Invalid Native Object" );
    if ( argc == 1 ) {
        const char *arg0;
        std::string arg0_tmp;
        ok &= jsval_to_std_string( cx, args.get( 0 ), &arg0_tmp );
        arg0 = arg0_tmp.c_str();
        JSB_PRECONDITION2( ok, cx, false,
                           "js_pluginx_protocols_ProtocolAnalytics_logTimedEventEnd : Error processing arguments" );
    ...
    JS_ReportError( cx,
                    "js_pluginx_protocols_ProtocolAnalytics_logTimedEventEnd : wrong number of arguments: %d, was expecting %d",
                    argc, 1 );
    return false;
}
...
void js_register_pluginx_protocols_ProtocolAnalytics( JSContext *cx, JS::HandleObject global ) {
    ...
    static JSFunctionSpec funcs[] = {
            JS_FN( "logTimedEventBegin", js_pluginx_protocols_ProtocolAnalytics_logTimedEventBegin, 1,
                   JSPROP_PERMANENT | JSPROP_ENUMERATE ),
            JS_FN( "logError", js_pluginx_protocols_ProtocolAnalytics_logError, 2,
                   JSPROP_PERMANENT | JSPROP_ENUMERATE ),
            JS_FN( "setCaptureUncaughtException", js_pluginx_protocols_ProtocolAnalytics_setCaptureUncaughtException, 1,
                   JSPROP_PERMANENT | JSPROP_ENUMERATE ),
            JS_FN( "setSessionContinueMillis", js_pluginx_protocols_ProtocolAnalytics_setSessionContinueMillis, 1,
                   JSPROP_PERMANENT | JSPROP_ENUMERATE ),
            JS_FN( "logEvent", js_pluginx_protocols_ProtocolAnalytics_logEvent, 1,
                   JSPROP_PERMANENT | JSPROP_ENUMERATE ),
            JS_FN( "startSession", js_pluginx_protocols_ProtocolAnalytics_startSession, 1,
                   JSPROP_PERMANENT | JSPROP_ENUMERATE ),
            JS_FN( "stopSession", js_pluginx_protocols_ProtocolAnalytics_stopSession, 0,
                   JSPROP_PERMANENT | JSPROP_ENUMERATE ),
            JS_FN( "logTimedEventEnd", js_pluginx_protocols_ProtocolAnalytics_logTimedEventEnd, 1,
                   JSPROP_PERMANENT | JSPROP_ENUMERATE ),
            JS_FS_END
    };
...
bool js_pluginx_protocols_ProtocolIAP_onPayResult( JSContext *cx, uint32_t argc, jsval *vp ) {
    ...
    JS_ReportError( cx,
                    "js_pluginx_protocols_ProtocolIAP_onPayResult : wrong number of arguments: %d, was expecting %d",
                    argc, 2 );
    return false;
}
...
#pragma warning NO CONVERSION FROM NATIVE FOR std::function;
    ...
    JS_ReportError( cx,
                    "js_pluginx_protocols_ProtocolIAP_getCallback : wrong number of arguments: %d, was expecting %d",
                    argc, 0 );
    return false;
}
...
bool js_pluginx_protocols_ProtocolIAP_configDeveloperInfo( JSContext *cx, uint32_t argc, jsval *vp ) {
    ...
    cocos2d::plugin::ProtocolIAP *cobj = ( cocos2d::plugin::ProtocolIAP * )( proxy ? proxy->ptr : NULL );
    JSB_PRECONDITION2( cobj, cx, false,
                       "js_pluginx_protocols_ProtocolIAP_configDeveloperInfo : Invalid Native Object" );
    if ( argc == 1 ) {
        std::map <std::string, std::string> arg0;
        ok &= jsval_to_std_map_string_string( cx, args.get( 0 ), &arg0 );
        JSB_PRECONDITION2( ok, cx, false,
                           "js_pluginx_protocols_ProtocolIAP_configDeveloperInfo : Error processing arguments" );
    ...
    JS_ReportError( cx,
                    "js_pluginx_protocols_ProtocolIAP_configDeveloperInfo : wrong number of arguments: %d, was expecting %d",
                    argc, 1 );
    return false;
}
...
void js_register_pluginx_protocols_ProtocolIAP( JSContext *cx, JS::HandleObject global ) {
    ...
    static JSFunctionSpec funcs[] = {
            JS_FN( "onPayResult", js_pluginx_protocols_ProtocolIAP_onPayResult, 2,
                   JSPROP_PERMANENT | JSPROP_ENUMERATE ),
            JS_FN( "getCallback", js_pluginx_protocols_ProtocolIAP_getCallback, 0,
                   JSPROP_PERMANENT | JSPROP_ENUMERATE ),
            JS_FN( "configDeveloperInfo", js_pluginx_protocols_ProtocolIAP_configDeveloperInfo, 1,
                   JSPROP_PERMANENT | JSPROP_ENUMERATE ),
            JS_FS_END
    };
...
bool js_pluginx_protocols_ProtocolAds_showAds( JSContext *cx, uint32_t argc, jsval *vp ) {
    ...
    JS_ReportError( cx, "js_pluginx_protocols_ProtocolAds_showAds : wrong number of arguments: %d, was expecting %d",
                    argc, 1 );
    return false;
}
...
bool js_pluginx_protocols_ProtocolAds_hideAds( JSContext *cx, uint32_t argc, jsval *vp ) {
    ...
    JS_ReportError( cx, "js_pluginx_protocols_ProtocolAds_hideAds : wrong number of arguments: %d, was expecting %d",
                    argc, 1 );
    return false;
}
...
bool js_pluginx_protocols_ProtocolAds_queryPoints( JSContext *cx, uint32_t argc, jsval *vp ) {
    ...
    JS_ReportError( cx,
                    "js_pluginx_protocols_ProtocolAds_queryPoints : wrong number of arguments: %d, was expecting %d",
                    argc, 0 );
    return false;
}
...
#pragma warning NO CONVERSION FROM NATIVE FOR std::function;
    ...
    JS_ReportError( cx,
                    "js_pluginx_protocols_ProtocolAds_getCallback : wrong number of arguments: %d, was expecting %d",
                    argc, 0 );
    return false;
}
...
bool js_pluginx_protocols_ProtocolAds_spendPoints( JSContext *cx, uint32_t argc, jsval *vp ) {
    ...
    JS_ReportError( cx,
                    "js_pluginx_protocols_ProtocolAds_spendPoints : wrong number of arguments: %d, was expecting %d",
                    argc, 1 );
    return false;
}
...
bool js_pluginx_protocols_ProtocolAds_configDeveloperInfo( JSContext *cx, uint32_t argc, jsval *vp ) {
    ...
    cocos2d::plugin::ProtocolAds *cobj = ( cocos2d::plugin::ProtocolAds * )( proxy ? proxy->ptr : NULL );
    JSB_PRECONDITION2( cobj, cx, false,
                       "js_pluginx_protocols_ProtocolAds_configDeveloperInfo : Invalid Native Object" );
    if ( argc == 1 ) {
        std::map <std::string, std::string> arg0;
        ok &= jsval_to_std_map_string_string( cx, args.get( 0 ), &arg0 );
        JSB_PRECONDITION2( ok, cx, false,
                           "js_pluginx_protocols_ProtocolAds_configDeveloperInfo : Error processing arguments" );
        cobj->configDeveloperInfo( arg0 );
        args.rval().setUndefined();
        return true;
    }
    ...
    JS_ReportError( cx,
                    "js_pluginx_protocols_ProtocolAds_configDeveloperInfo : wrong number of arguments: %d, was expecting %d",
                    argc, 1 );
    return false;
}
...
void js_register_pluginx_protocols_ProtocolAds( JSContext *cx, JS::HandleObject global ) {
    ...
    static JSFunctionSpec funcs[] = {
            ...
            JS_FN( "queryPoints", js_pluginx_protocols_ProtocolAds_queryPoints, 0,
                   JSPROP_PERMANENT | JSPROP_ENUMERATE ),
            JS_FN( "getCallback", js_pluginx_protocols_ProtocolAds_getCallback, 0,
                   JSPROP_PERMANENT | JSPROP_ENUMERATE ),
            JS_FN( "spendPoints", js_pluginx_protocols_ProtocolAds_spendPoints, 1,
                   JSPROP_PERMANENT | JSPROP_ENUMERATE ),
            JS_FN( "configDeveloperInfo", js_pluginx_protocols_ProtocolAds_configDeveloperInfo, 1,
                   JSPROP_PERMANENT | JSPROP_ENUMERATE ),
            JS_FS_END
    };
...
bool js_pluginx_protocols_ProtocolShare_onShareResult( JSContext *cx, uint32_t argc, jsval *vp ) {
    ...
    if ( argc == 2 ) {
        ...
        arg1 = arg1_tmp.c_str();
        JSB_PRECONDITION2( ok, cx, false,
                           "js_pluginx_protocols_ProtocolShare_onShareResult : Error processing arguments" );
    ...
    JS_ReportError( cx,
                    "js_pluginx_protocols_ProtocolShare_onShareResult : wrong number of arguments: %d, was expecting %d",
                    argc, 2 );
    return false;
}
...
#pragma warning NO CONVERSION FROM NATIVE FOR std::function;
    ...
    JS_ReportError( cx,
                    "js_pluginx_protocols_ProtocolShare_getCallback : wrong number of arguments: %d, was expecting %d",
                    argc, 0 );
    return false;
}
...
bool js_pluginx_protocols_ProtocolShare_configDeveloperInfo( JSContext *cx, uint32_t argc, jsval *vp ) {
    ...
    cocos2d::plugin::ProtocolShare *cobj = ( cocos2d::plugin::ProtocolShare * )( proxy ? proxy->ptr : NULL );
    JSB_PRECONDITION2( cobj, cx, false,
                       "js_pluginx_protocols_ProtocolShare_configDeveloperInfo : Invalid Native Object" );
    if ( argc == 1 ) {
        std::map <std::string, std::string> arg0;
        ok &= jsval_to_std_map_string_string( cx, args.get( 0 ), &arg0 );
        JSB_PRECONDITION2( ok, cx, false,
                           "js_pluginx_protocols_ProtocolShare_configDeveloperInfo : Error processing arguments" );
        cobj->configDeveloperInfo( arg0 );
        args.rval().setUndefined();
        return true;
    }
    ...
    JS_ReportError( cx,
                    "js_pluginx_protocols_ProtocolShare_configDeveloperInfo : wrong number of arguments: %d, was expecting %d",
                    argc, 1 );
    return false;
}
...
void js_register_pluginx_protocols_ProtocolShare( JSContext *cx, JS::HandleObject global ) {
    ...
    static JSFunctionSpec funcs[] = {
            JS_FN( "onShareResult", js_pluginx_protocols_ProtocolShare_onShareResult, 2,
                   JSPROP_PERMANENT | JSPROP_ENUMERATE ),
            JS_FN( "getCallback", js_pluginx_protocols_ProtocolShare_getCallback, 0,
                   JSPROP_PERMANENT | JSPROP_ENUMERATE ),
            JS_FN( "configDeveloperInfo", js_pluginx_protocols_ProtocolShare_configDeveloperInfo, 1,
                   JSPROP_PERMANENT | JSPROP_ENUMERATE ),
            JS_FS_END
    };
...
bool js_pluginx_protocols_ProtocolSocial_showLeaderboard( JSContext *cx, uint32_t argc, jsval *vp ) {
    ...
    if ( argc == 1 ) {
        ...
        arg0 = arg0_tmp.c_str();
        JSB_PRECONDITION2( ok, cx, false,
                           "js_pluginx_protocols_ProtocolSocial_showLeaderboard : Error processing arguments" );
    ...
    JS_ReportError( cx,
                    "js_pluginx_protocols_ProtocolSocial_showLeaderboard : wrong number of arguments: %d, was expecting %d",
                    argc, 1 );
    return false;
}
...
bool js_pluginx_protocols_ProtocolSocial_showAchievements( JSContext *cx, uint32_t argc, jsval *vp ) {
    ...
    cocos2d::plugin::ProtocolSocial *cobj = ( cocos2d::plugin::ProtocolSocial * )( proxy ? proxy->ptr : NULL );
    JSB_PRECONDITION2( cobj, cx, false,
                       "js_pluginx_protocols_ProtocolSocial_showAchievements : Invalid Native Object" );
    if ( argc == 0 ) {
    ...
    JS_ReportError( cx,
                    "js_pluginx_protocols_ProtocolSocial_showAchievements : wrong number of arguments: %d, was expecting %d",
                    argc, 0 );
    return false;
}
...
#pragma warning NO CONVERSION FROM NATIVE FOR std::function;
    ...
    JS_ReportError( cx,
                    "js_pluginx_protocols_ProtocolSocial_getCallback : wrong number of arguments: %d, was expecting %d",
                    argc, 0 );
    return false;
}
...
bool js_pluginx_protocols_ProtocolSocial_configDeveloperInfo( JSContext *cx, uint32_t argc, jsval *vp ) {
    ...
    cocos2d::plugin::ProtocolSocial *cobj = ( cocos2d::plugin::ProtocolSocial * )( proxy ? proxy->ptr : NULL );
    JSB_PRECONDITION2( cobj, cx, false,
                       "js_pluginx_protocols_ProtocolSocial_configDeveloperInfo : Invalid Native Object" );
    if ( argc == 1 ) {
        std::map <std::string, std::string> arg0;
        ok &= jsval_to_std_map_string_string( cx, args.get( 0 ), &arg0 );
        JSB_PRECONDITION2( ok, cx, false,
                           "js_pluginx_protocols_ProtocolSocial_configDeveloperInfo : Error processing arguments" );
        cobj->configDeveloperInfo( arg0 );
        args.rval().setUndefined();
        return true;
    }
    ...
    JS_ReportError( cx,
                    "js_pluginx_protocols_ProtocolSocial_configDeveloperInfo : wrong number of arguments: %d, was expecting %d",
                    argc, 1 );
    return false;
}
...
void js_register_pluginx_protocols_ProtocolSocial( JSContext *cx, JS::HandleObject global ) {
    ...
    static JSFunctionSpec funcs[] = {
            JS_FN( "showLeaderboard", js_pluginx_protocols_ProtocolSocial_showLeaderboard, 1,
                   JSPROP_PERMANENT | JSPROP_ENUMERATE ),
            JS_FN( "showAchievements", js_pluginx_protocols_ProtocolSocial_showAchievements, 0,
                   JSPROP_PERMANENT | JSPROP_ENUMERATE ),
            JS_FN( "getCallback", js_pluginx_protocols_ProtocolSocial_getCallback, 0,
                   JSPROP_PERMANENT | JSPROP_ENUMERATE ),
            JS_FN( "configDeveloperInfo", js_pluginx_protocols_ProtocolSocial_configDeveloperInfo, 1,
                   JSPROP_PERMANENT | JSPROP_ENUMERATE ),
            JS_FS_END
    };
...
#pragma warning NO CONVERSION FROM NATIVE FOR std::function;
    ...
    JS_ReportError( cx,
                    "js_pluginx_protocols_ProtocolUser_getCallback : wrong number of arguments: %d, was expecting %d",
                    argc, 0 );
    return false;
}
...
bool js_pluginx_protocols_ProtocolUser_configDeveloperInfo( JSContext *cx, uint32_t argc, jsval *vp ) {
    ...
    cocos2d::plugin::ProtocolUser *cobj = ( cocos2d::plugin::ProtocolUser * )( proxy ? proxy->ptr : NULL );
    JSB_PRECONDITION2( cobj, cx, false,
                       "js_pluginx_protocols_ProtocolUser_configDeveloperInfo : Invalid Native Object" );
    if ( argc == 1 ) {
        std::map <std::string, std::string> arg0;
        ok &= jsval_to_std_map_string_string( cx, args.get( 0 ), &arg0 );
        JSB_PRECONDITION2( ok, cx, false,
                           "js_pluginx_protocols_ProtocolUser_configDeveloperInfo : Error processing arguments" );
        cobj->configDeveloperInfo( arg0 );
        args.rval().setUndefined();
        return true;
    }
    ...
    JS_ReportError( cx,
                    "js_pluginx_protocols_ProtocolUser_configDeveloperInfo : wrong number of arguments: %d, was expecting %d",
                    argc, 1 );
    return false;
}
...
bool js_pluginx_protocols_ProtocolUser_isLoggedIn( JSContext *cx, uint32_t argc, jsval *vp ) {
    ...
    JS_ReportError( cx,
                    "js_pluginx_protocols_ProtocolUser_isLoggedIn : wrong number of arguments: %d, was expecting %d",
                    argc, 0 );
    return false;
}
...
bool js_pluginx_protocols_ProtocolUser_getSessionID( JSContext *cx, uint32_t argc, jsval *vp ) {
    ...
    JS_ReportError( cx,
                    "js_pluginx_protocols_ProtocolUser_getSessionID : wrong number of arguments: %d, was expecting %d",
                    argc, 0 );
    return false;
}
...
bool js_pluginx_protocols_ProtocolUser_getAccessToken( JSContext *cx, uint32_t argc, jsval *vp ) {
    ...
    JS_ReportError( cx,
                    "js_pluginx_protocols_ProtocolUser_getAccessToken : wrong number of arguments: %d, was expecting %d",
                    argc, 0 );
    return false;
}
...
void js_register_pluginx_protocols_ProtocolUser( JSContext *cx, JS::HandleObject global ) {
    ...
    static JSFunctionSpec funcs[] = {
            JS_FN( "getCallback", js_pluginx_protocols_ProtocolUser_getCallback, 0,
                   JSPROP_PERMANENT | JSPROP_ENUMERATE ),
            JS_FN( "configDeveloperInfo", js_pluginx_protocols_ProtocolUser_configDeveloperInfo, 1,
                   JSPROP_PERMANENT | JSPROP_ENUMERATE ),
            JS_FN( "isLoggedIn", js_pluginx_protocols_ProtocolUser_isLoggedIn, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE ),
            JS_FN( "getSessionID", js_pluginx_protocols_ProtocolUser_getSessionID, 0,
                   JSPROP_PERMANENT | JSPROP_ENUMERATE ),
            JS_FN( "getAccessToken", js_pluginx_protocols_ProtocolUser_getAccessToken, 0,
                   JSPROP_PERMANENT | JSPROP_ENUMERATE ),
            JS_FS_END
    };
...
bool js_pluginx_protocols_AgentManager_getSocialPlugin( JSContext *cx, uint32_t argc, jsval *vp ) {
    ...
    if ( argc == 0 ) {
        ...
        do {
            if ( ret ) {
                js_proxy_t *jsProxy = js_get_or_create_proxy<cocos2d::plugin::ProtocolSocial>( cx,
                                                                                               ( cocos2d::plugin::ProtocolSocial * ) ret );
                jsret = OBJECT_TO_JSVAL( jsProxy->obj );
            } else {
                jsret = JSVAL_NULL;
            }
    ...
    JS_ReportError( cx,
                    "js_pluginx_protocols_AgentManager_getSocialPlugin : wrong number of arguments: %d, was expecting %d",
                    argc, 0 );
    return false;
}
...
bool js_pluginx_protocols_AgentManager_getAdsPlugin( JSContext *cx, uint32_t argc, jsval *vp ) {
    ...
    if ( argc == 0 ) {
        ...
        do {
            if ( ret ) {
                js_proxy_t *jsProxy = js_get_or_create_proxy<cocos2d::plugin::ProtocolAds>( cx,
                                                                                            ( cocos2d::plugin::ProtocolAds * ) ret );
                jsret = OBJECT_TO_JSVAL( jsProxy->obj );
            } else {
                jsret = JSVAL_NULL;
            }
    ...
    JS_ReportError( cx,
                    "js_pluginx_protocols_AgentManager_getAdsPlugin : wrong number of arguments: %d, was expecting %d",
                    argc, 0 );
    return false;
}
...
bool js_pluginx_protocols_AgentManager_purge( JSContext *cx, uint32_t argc, jsval *vp ) {
    ...
    JS_ReportError( cx, "js_pluginx_protocols_AgentManager_purge : wrong number of arguments: %d, was expecting %d",
                    argc, 0 );
    return false;
}
...
bool js_pluginx_protocols_AgentManager_getUserPlugin( JSContext *cx, uint32_t argc, jsval *vp ) {
    ...
    if ( argc == 0 ) {
        ...
        do {
            if ( ret ) {
                js_proxy_t *jsProxy = js_get_or_create_proxy<cocos2d::plugin::ProtocolUser>( cx,
                                                                                             ( cocos2d::plugin::ProtocolUser * ) ret );
                jsret = OBJECT_TO_JSVAL( jsProxy->obj );
            } else {
                jsret = JSVAL_NULL;
            }
    ...
    JS_ReportError( cx,
                    "js_pluginx_protocols_AgentManager_getUserPlugin : wrong number of arguments: %d, was expecting %d",
                    argc, 0 );
    return false;
}
...
bool js_pluginx_protocols_AgentManager_getIAPPlugin( JSContext *cx, uint32_t argc, jsval *vp ) {
    ...
    if ( argc == 0 ) {
        ...
        do {
            if ( ret ) {
                js_proxy_t *jsProxy = js_get_or_create_proxy<cocos2d::plugin::ProtocolIAP>( cx,
                                                                                            ( cocos2d::plugin::ProtocolIAP * ) ret );
                jsret = OBJECT_TO_JSVAL( jsProxy->obj );
            } else {
                jsret = JSVAL_NULL;
            }
    ...
    JS_ReportError( cx,
                    "js_pluginx_protocols_AgentManager_getIAPPlugin : wrong number of arguments: %d, was expecting %d",
                    argc, 0 );
    return false;
}
...
bool js_pluginx_protocols_AgentManager_getSharePlugin( JSContext *cx, uint32_t argc, jsval *vp ) {
    ...
    if ( argc == 0 ) {
        ...
        do {
            if ( ret ) {
                js_proxy_t *jsProxy = js_get_or_create_proxy<cocos2d::plugin::ProtocolShare>( cx,
                                                                                              ( cocos2d::plugin::ProtocolShare * ) ret );
                jsret = OBJECT_TO_JSVAL( jsProxy->obj );
            } else {
                jsret = JSVAL_NULL;
            }
    ...
    JS_ReportError( cx,
                    "js_pluginx_protocols_AgentManager_getSharePlugin : wrong number of arguments: %d, was expecting %d",
                    argc, 0 );
    return false;
}
...
bool js_pluginx_protocols_AgentManager_getAnalyticsPlugin( JSContext *cx, uint32_t argc, jsval *vp ) {
    ...
    cocos2d::plugin::AgentManager *cobj = ( cocos2d::plugin::AgentManager * )( proxy ? proxy->ptr : NULL );
    JSB_PRECONDITION2( cobj, cx, false,
                       "js_pluginx_protocols_AgentManager_getAnalyticsPlugin : Invalid Native Object" );
    if ( argc == 0 ) {
        cocos2d::plugin::ProtocolAnalytics *ret = cobj->getAnalyticsPlugin();
        jsval jsret = JSVAL_NULL;
        do {
            if ( ret ) {
                js_proxy_t *jsProxy = js_get_or_create_proxy<cocos2d::plugin::ProtocolAnalytics>( cx,
                                                                                                  ( cocos2d::plugin::ProtocolAnalytics * ) ret );
                jsret = OBJECT_TO_JSVAL( jsProxy->obj );
            } else {
                jsret = JSVAL_NULL;
            }
    ...
    JS_ReportError( cx,
                    "js_pluginx_protocols_AgentManager_getAnalyticsPlugin : wrong number of arguments: %d, was expecting %d",
                    argc, 0 );
    return false;
}
...
bool js_pluginx_protocols_AgentManager_getInstance( JSContext *cx, uint32_t argc, jsval *vp ) {
    ...
    if ( argc == 0 ) {
        ...
        do {
            if ( ret ) {
                js_proxy_t *jsProxy = js_get_or_create_proxy<cocos2d::plugin::AgentManager>( cx,
                                                                                             ( cocos2d::plugin::AgentManager * ) ret );
                jsret = OBJECT_TO_JSVAL( jsProxy->obj );
            } else {
                jsret = JSVAL_NULL;
            }
...
void js_register_pluginx_protocols_AgentManager( JSContext *cx, JS::HandleObject global ) {
    ...
    static JSFunctionSpec funcs[] = {
            JS_FN( "getSocialPlugin", js_pluginx_protocols_AgentManager_getSocialPlugin, 0,
                   JSPROP_PERMANENT | JSPROP_ENUMERATE ),
            JS_FN( "getAdsPlugin", js_pluginx_protocols_AgentManager_getAdsPlugin, 0,
                   JSPROP_PERMANENT | JSPROP_ENUMERATE ),
            JS_FN( "purge", js_pluginx_protocols_AgentManager_purge, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE ),
            JS_FN( "getUserPlugin", js_pluginx_protocols_AgentManager_getUserPlugin, 0,
                   JSPROP_PERMANENT | JSPROP_ENUMERATE ),
            JS_FN( "getIAPPlugin", js_pluginx_protocols_AgentManager_getIAPPlugin, 0,
                   JSPROP_PERMANENT | JSPROP_ENUMERATE ),
            JS_FN( "getSharePlugin", js_pluginx_protocols_AgentManager_getSharePlugin, 0,
                   JSPROP_PERMANENT | JSPROP_ENUMERATE ),
            JS_FN( "getAnalyticsPlugin", js_pluginx_protocols_AgentManager_getAnalyticsPlugin, 0,
                   JSPROP_PERMANENT | JSPROP_ENUMERATE ),
            JS_FS_END
    };

    static JSFunctionSpec st_funcs[] = {
            JS_FN( "destroyInstance", js_pluginx_protocols_AgentManager_destroyInstance, 0,
                   JSPROP_PERMANENT | JSPROP_ENUMERATE ),
            JS_FN( "getInstance", js_pluginx_protocols_AgentManager_getInstance, 0,
                   JSPROP_PERMANENT | JSPROP_ENUMERATE ),
            JS_FS_END
    };
...
bool js_pluginx_protocols_FacebookAgent_activateApp( JSContext *cx, uint32_t argc, jsval *vp ) {
    ...
    JS_ReportError( cx,
                    "js_pluginx_protocols_FacebookAgent_activateApp : wrong number of arguments: %d, was expecting %d",
                    argc, 0 );
    return false;
}
...
bool js_pluginx_protocols_FacebookAgent_getUserID( JSContext *cx, uint32_t argc, jsval *vp ) {
    ...
    JS_ReportError( cx,
                    "js_pluginx_protocols_FacebookAgent_getUserID : wrong number of arguments: %d, was expecting %d",
                    argc, 0 );
    return false;
}
...
bool js_pluginx_protocols_FacebookAgent_logout( JSContext *cx, uint32_t argc, jsval *vp ) {
    ...
    JS_ReportError( cx, "js_pluginx_protocols_FacebookAgent_logout : wrong number of arguments: %d, was expecting %d",
                    argc, 0 );
    return false;
}
...
bool js_pluginx_protocols_FacebookAgent_getSDKVersion( JSContext *cx, uint32_t argc, jsval *vp ) {
    ...
    JS_ReportError( cx,
                    "js_pluginx_protocols_FacebookAgent_getSDKVersion : wrong number of arguments: %d, was expecting %d",
                    argc, 0 );
    return false;
}
...
bool js_pluginx_protocols_FacebookAgent_isLoggedIn( JSContext *cx, uint32_t argc, jsval *vp ) {
    ...
    JS_ReportError( cx,
                    "js_pluginx_protocols_FacebookAgent_isLoggedIn : wrong number of arguments: %d, was expecting %d",
                    argc, 0 );
    return false;
}
...
bool js_pluginx_protocols_FacebookAgent_canPresentDialogWithParams( JSContext *cx, uint32_t argc, jsval *vp ) {
    ...
    cocos2d::plugin::FacebookAgent *cobj = ( cocos2d::plugin::FacebookAgent * )( proxy ? proxy->ptr : NULL );
    JSB_PRECONDITION2( cobj, cx, false,
                       "js_pluginx_protocols_FacebookAgent_canPresentDialogWithParams : Invalid Native Object" );
    if ( argc == 1 ) {
        std::map <std::string, std::string> arg0;
        ok &= jsval_to_std_map_string_string( cx, args.get( 0 ), &arg0 );
        JSB_PRECONDITION2( ok, cx, false,
                           "js_pluginx_protocols_FacebookAgent_canPresentDialogWithParams : Error processing arguments" );
    ...
    JS_ReportError( cx,
                    "js_pluginx_protocols_FacebookAgent_canPresentDialogWithParams : wrong number of arguments: %d, was expecting %d",
                    argc, 1 );
    return false;
}
...
bool js_pluginx_protocols_FacebookAgent_getAccessToken( JSContext *cx, uint32_t argc, jsval *vp ) {
    ...
    JS_ReportError( cx,
                    "js_pluginx_protocols_FacebookAgent_getAccessToken : wrong number of arguments: %d, was expecting %d",
                    argc, 0 );
    return false;
}
...
bool js_pluginx_protocols_FacebookAgent_getInstanceJs( JSContext *cx, uint32_t argc, jsval *vp ) {
    ...
    if ( argc == 0 ) {
        ...
        do {
            if ( ret ) {
                js_proxy_t *jsProxy = js_get_or_create_proxy<cocos2d::plugin::FacebookAgent>( cx,
                                                                                              ( cocos2d::plugin::FacebookAgent * ) ret );
                jsret = OBJECT_TO_JSVAL( jsProxy->obj );
            } else {
                jsret = JSVAL_NULL;
            }
...
void js_register_pluginx_protocols_FacebookAgent( JSContext *cx, JS::HandleObject global ) {
    ...
    static JSFunctionSpec funcs[] = {
            JS_FN( "activateApp", js_pluginx_protocols_FacebookAgent_activateApp, 0,
                   JSPROP_PERMANENT | JSPROP_ENUMERATE ),
            ...
            JS_FN( "getSDKVersion", js_pluginx_protocols_FacebookAgent_getSDKVersion, 0,
                   JSPROP_PERMANENT | JSPROP_ENUMERATE ),
            JS_FN( "logPurchase", js_pluginx_protocols_FacebookAgent_logPurchase, 2,
                   JSPROP_PERMANENT | JSPROP_ENUMERATE ),
            JS_FN( "isLoggedIn", js_pluginx_protocols_FacebookAgent_isLoggedIn, 0,
                   JSPROP_PERMANENT | JSPROP_ENUMERATE ),
            JS_FN( "canPresentDialog", js_pluginx_protocols_FacebookAgent_canPresentDialogWithParams, 1,
                   JSPROP_PERMANENT | JSPROP_ENUMERATE ),
            JS_FN( "getAccessToken", js_pluginx_protocols_FacebookAgent_getAccessToken, 0,
                   JSPROP_PERMANENT | JSPROP_ENUMERATE ),
            JS_FS_END
    };

    static JSFunctionSpec st_funcs[] = {
            JS_FN( "destroyInstance", js_pluginx_protocols_FacebookAgent_destroyInstance, 0,
                   JSPROP_PERMANENT | JSPROP_ENUMERATE ),
            JS_FN( "getInstanceJs", js_pluginx_protocols_FacebookAgent_getInstanceJs, 0,
                   JSPROP_PERMANENT | JSPROP_ENUMERATE ),
            JS_FS_END
    };
