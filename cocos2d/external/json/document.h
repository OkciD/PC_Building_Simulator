...
// TypeHelper
    ...
    namespace internal {
        ...
        struct TypeHelper<ValueType, unsigned> {
            ...
            static ValueType &
            Set( ValueType &v, unsigned data, typename ValueType::AllocatorType & ) { return v.SetUint( data ); }
        };
        ...
        struct TypeHelper<ValueType, int64_t> {
            ...
            static ValueType &
            Set( ValueType &v, int64_t data, typename ValueType::AllocatorType & ) { return v.SetInt64( data ); }
        };
        ...
        struct TypeHelper<ValueType, double> {
            ...
            static ValueType &
            Set( ValueType &v, double data, typename ValueType::AllocatorType & ) { return v.SetDouble( data ); }
        };
...
*/
    ...
    */
     ...
     */
        ...
        template<typename T>
        explicit
        GenericValue( T b, RAPIDJSON_ENABLEIF( ( internal::IsSame<bool, T> ) ) ) RAPIDJSON_NOEXCEPT  // See #472
#else
