...
struct jpeg_error_mgr {
    ...
    JMETHOD( noreturn_t, error_exit, ( j_common_ptr
            cinfo) );
...
EXTERN( void ) jpeg_mem_dest JPP( ( j_compress_ptr
                                          cinfo,
                                                  unsigned
                                          char **outbuffer,
                                          unsigned long *outsize) );
EXTERN( void ) jpeg_mem_src JPP( ( j_decompress_ptr
                                         cinfo,
                                                 unsigned
                                         char *inbuffer,
...
EXTERN( void ) jpeg_set_linear_quality JPP( ( j_compress_ptr
                                                    ...
                                                    scale_factor,
                                                            boolean
                                                    force_baseline) );
EXTERN( void ) jpeg_default_qtables JPP( ( j_compress_ptr
                                                 cinfo,
                                                         boolean
                                                 force_baseline) );
...
EXTERN( void ) jpeg_calc_jpeg_dimensions JPP( ( j_compress_ptr
                                                      cinfo) );
...
EXTERN( void ) jpeg_core_output_dimensions JPP( ( j_decompress_ptr
                                                        cinfo) );
