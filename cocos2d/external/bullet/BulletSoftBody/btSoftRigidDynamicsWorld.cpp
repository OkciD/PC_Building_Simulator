...
void btSoftRigidDynamicsWorld::addSoftBody( btSoftBody *body, short int collisionFilterGroup,
...
struct btSoftSingleRayCallback : public btBroadphaseRayCallback {
    ...
    btSoftSingleRayCallback( const btVector3 &rayFromWorld, const btVector3 &rayToWorld,
...
void btSoftRigidDynamicsWorld::rayTest( const btVector3 &rayFromWorld, const btVector3 &rayToWorld,
...
void btSoftRigidDynamicsWorld::rayTestSingle( const btTransform &rayFromTrans, const btTransform &rayToTrans,
    ...
    if ( collisionShape->isSoftBody() ) {
        ...
        btCollisionWorld::rayTestSingle( rayFromTrans, rayToTrans, collisionObject, collisionShape,
                                         colObjWorldTransform, resultCallback );
    }
}
