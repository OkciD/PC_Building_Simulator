...
public:
    ...
    btSoftBodyTriangleCallback( btDispatcher *dispatcher, const btCollisionObjectWrapper *body0Wrap,
                                const btCollisionObjectWrapper *body1Wrap, bool isSwapped );

    void setTimeStepAndCounters( btScalar collisionMarginTriangle, const btCollisionObjectWrapper *triObjWrap,
    ...
    SIMD_FORCE_INLINE const btVector3
    &
...
public:
    ...
    btSoftBodyConcaveCollisionAlgorithm( const btCollisionAlgorithmConstructionInfo &ci,
    ...
    btScalar
    calculateTimeOfImpact( btCollisionObject *body0, btCollisionObject *body1, const btDispatcherInfo &dispatchInfo,
    ...
    struct CreateFunc : public btCollisionAlgorithmCreateFunc {
        ...
        CreateCollisionAlgorithm( btCollisionAlgorithmConstructionInfo &ci, const btCollisionObjectWrapper *body0Wrap,
