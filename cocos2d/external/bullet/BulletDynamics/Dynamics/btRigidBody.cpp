...
btRigidBody::btRigidBody( btScalar mass, btMotionState *motionState, btCollisionShape *collisionShape,
...
void btRigidBody::predictIntegratedTransform( btScalar timeStep, btTransform &predictedTransform ) {
    btTransformUtil::integrateTransform( m_worldTransform, m_linearVelocity, m_angularVelocity, timeStep,
                                         predictedTransform );
}
...
void btRigidBody::saveKinematicState( btScalar timeStep ) {
    ...
    if ( timeStep != btScalar( 0. ) ) {
        ...
        btTransformUtil::calculateVelocity( m_interpolationWorldTransform, m_worldTransform, timeStep, m_linearVelocity,
                                            m_angularVelocity );
...
void btRigidBody::updateInertiaTensor() {
    m_invInertiaTensorWorld =
            m_worldTransform.getBasis().scaled( m_invInertiaLocal ) * m_worldTransform.getBasis().transpose();
}
...
btVector3 btRigidBody::computeGyroscopicForce( btScalar maxGyroscopicForce ) const {
    ...
    btMatrix3x3 inertiaTensorWorld =
            getWorldTransform().getBasis().scaled( inertiaLocal ) * getWorldTransform().getBasis().transpose();
