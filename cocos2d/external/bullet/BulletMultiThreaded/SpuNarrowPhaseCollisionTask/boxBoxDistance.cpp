...
VertexBFaceATest(
    ...
    vmVector3 facePointB =
            vmVector3(
                    mulPerElem( faceOffsetBA + matrixBA.getCol0() * t0 + matrixBA.getCol1() * t1 - scalesB, signsB ) );
...
VertexAFaceBTest(
    ...
    vmVector3 facePointA =
            vmVector3(
                    mulPerElem( faceOffsetAB + matrixAB.getCol0() * t0 + matrixAB.getCol1() * t1 - scalesA, signsA ) );
