...
#include "bullet/BulletMultiThreaded/btGpuDefines.h"
#include "bullet/BulletMultiThreaded/btGpuUtilsSharedDefs.h"
#include "bullet/BulletMultiThreaded/btGpuUtilsSharedCode.h"
...
btBroadphaseProxy *
btGpu3DGridBroadphase::createProxy( const btVector3 &aabbMin, const btVector3 &aabbMax, int shapeType, void *userPtr,
    ...
    if ( bIsLarge ) {
        ...
        proxy = new( &m_pLargeHandles[newHandleIndex] )btSimpleBroadphaseProxy( aabbMin, aabbMax, shapeType, userPtr,
                                                                                collisionFilterGroup,
                                                                                collisionFilterMask, multiSapProxy );
    } else {
        proxy = btSimpleBroadphase::createProxy( aabbMin, aabbMax, shapeType, userPtr, collisionFilterGroup,
...
void
btGpu3DGridBroadphase::rayTest( const btVector3 &rayFrom, const btVector3 &rayTo, btBroadphaseRayCallback &rayCallback,
...
void btGpu3DGridBroadphase::findPairsLarge() {
    ...
    btGpu_findPairsLarge( m_hAABB, m_hBodiesHash, m_hCellStart, m_hPairBuff, m_hPairBuffStartCurr, m_numHandles,
                          m_numLargeHandles );
    return;
}
...
void btGpu3DGridBroadphase::squeezeOverlappingPairBuff() {
    ...
    btGpu_squeezeOverlappingPairBuff( m_hPairBuff, m_hPairBuffStartCurr, m_hPairScan, m_hPairOut, m_hAABB,
                                      m_numHandles );
    return;
}
