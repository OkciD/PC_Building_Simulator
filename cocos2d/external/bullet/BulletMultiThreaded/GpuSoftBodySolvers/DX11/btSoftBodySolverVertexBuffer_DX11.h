...
public:
     ...
     */
    btDX11VertexBufferDescriptor( ID3D11DeviceContext *context, ID3D11Buffer *buffer, ID3D11UnorderedAccessView *UAV,
     ...
     */
    btDX11VertexBufferDescriptor( ID3D11DeviceContext *context, ID3D11Buffer *buffer, ID3D11UnorderedAccessView *UAV,
                                  int vertexOffset, int vertexStride, int normalOffset, int normalStride ) {
        m_context = context;
        m_vertexBuffer = buffer;
        m_vertexBufferUAV = UAV;
        m_vertexOffset = vertexOffset;
