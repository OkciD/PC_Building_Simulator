...
public:
     ...
     */
    virtual cl_kernel
    compileCLKernelFromString( const char *kernelSource, const char *kernelName, const char *additionalMacros,
...
protected:
    ...
    void ApplyClampedForce( float solverdt, const Vectormath::Aos::Vector3 &force,
