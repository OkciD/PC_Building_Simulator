...
inline void btDbvt::rayTest( const btDbvtNode *root,
    ...
    if ( root ) {
        ...
        do {
            ...
            btScalar tmin = 1.f, lambda_min = 0.f;
            unsigned int result1 = btRayAabb2( rayFrom, rayDirectionInverse, signs, bounds, tmin, lambda_min,
                                               lambda_max );
...
inline void btDbvt::collideOCL( const btDbvtNode *root,
    ...
    if ( root ) {
        ...
        stack.push_back(
                allocate( ifree, stock, sStkNPS( root, 0, root->volume.ProjectMinimum( sortaxis, srtsgns ) ) ) );
        do {
