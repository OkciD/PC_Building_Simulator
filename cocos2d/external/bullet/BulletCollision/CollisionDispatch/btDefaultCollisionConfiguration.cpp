...
//btDefaultCollisionConfiguration::btDefaultCollisionConfiguration(btStackAlloc*	stackAlloc,btPoolAllocator*	persistentManifoldPool,btPoolAllocator*	collisionAlgorithmPool)
{
    ...
    if ( constructionInfo.m_persistentManifoldPool ) {
        ...
        m_persistentManifoldPool = new( mem ) btPoolAllocator( sizeof( btPersistentManifold ),
    ...
    if ( constructionInfo.m_collisionAlgorithmPool ) {
        ...
        void *mem = btAlignedAlloc( sizeof( btPoolAllocator ), 16 );
        m_collisionAlgorithmPool = new( mem ) btPoolAllocator( collisionAlgorithmMaxElementSize,
...
btDefaultCollisionConfiguration::getCollisionAlgorithmCreateFunc( int proxyType0, int proxyType1 ) {
...
void btDefaultCollisionConfiguration::setConvexConvexMultipointIterations( int numPerturbationIterations,
...
void btDefaultCollisionConfiguration::setPlaneConvexMultipointIterations( int numPerturbationIterations,
                                                                          int minimumPointsPerturbationThreshold ) {
