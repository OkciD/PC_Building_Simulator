...
const int32 is_ratio_factor[8] = { 0,
                                   Q31_fmt( 0.21132486540519 ), Q31_fmt( 0.36602540378444 ),
                                   Q31_fmt( 0.50000000000000 ),
                                   Q31_fmt( 0.63397459621556 ), Q31_fmt( 0.78867513459481 ),
                                   Q31_fmt( 1.00000000000000 ),
                                   0
};
            ...
            if ( gr_info->mixed_block_flag ) {
                ...
                if ( sb < 36 ) {
                    ...
                    for ( ; sfbTemp < 8; sfbTemp++ ) {
                        ...
                        sfbNo = mp3_sfBandIndex[sfreq].l[sfbTemp + 1] -
                                mp3_sfBandIndex[sfreq].l[sfbTemp]; /* No of lines to process */
                    ...
                    for ( j = 0; j < 3; j++ ) {
                        ...
                        for ( sfbTemp = 3; sfbTemp < 13; sfbTemp++ ) {
                            sfbNo = mp3_sfBandIndex[sfreq].s[sfbTemp + 1] -
                                    mp3_sfBandIndex[sfreq].s[sfbTemp]; /* No of lines to process */
